...
import de.gerdiproject.harvest.etls.ClinicalTrialsETL;
 ...
 */
@WebListener
public class ClinicalTrialsContextListener extends ContextListener
{
    @Override
    protected List<? extends AbstractETL<?, ?>> createETLs()
    {
        return Arrays.asList(new ClinicalTrialsETL());
    }
}
